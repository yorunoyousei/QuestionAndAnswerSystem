...
/*
 * API for updating the Comment with {commentId} under Question with {questionId} in {category} collection of the database
 *
 * HTTP Request: PUT /questions/{category}/{questionId}/comments/{commentId}
 * HTTP Response:
...
public class UpdateCommentController {
	...
	@RequestMapping(value = "/questions/{category}/{questionId}/comments/{commentId}", method=RequestMethod.PUT)
	public Comment updateComment(@PathVariable String category, @PathVariable String questionId,
