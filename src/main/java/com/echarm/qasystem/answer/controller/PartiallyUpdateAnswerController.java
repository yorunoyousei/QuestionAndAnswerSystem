...
/*
 * API for partially updating the Answer with {answerId} under Question with {questionId} in {category} collection of the database
 *
 * HTTP Request: PATCH /questions/{category}/{questionId}/answers/{answerId}
 * HTTP Response:
 ...
 */
@RestController
public class PartiallyUpdateAnswerController {
	...
	@RequestMapping(value = "/questions/{category}/{questionId}/answers/{answerId}", method=RequestMethod.PATCH)
	public Answer partiallyUpdateAnswer(@PathVariable String category, @PathVariable String questionId,
