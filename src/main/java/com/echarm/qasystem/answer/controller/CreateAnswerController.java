...
/*
 * API for creating a Answer under Question with {questionId} in {category} collection of the database
 *
 * HTTP Request: POST /questions/{category}/{questionId}/answers
 * HTTP Response:
 *       Status Code  Json Body              Description
 *    1. 201          Answer                 Successful Operation
...
public class CreateAnswerController {
    ...
    @RequestMapping(value = "/questions/{category}/{questionId}/answers", method = RequestMethod.POST)
    public Answer createAnswer(@RequestBody Answer answer, @PathVariable String category, @PathVariable String questionId)
                                 throws InvalidParameterException, ResourceNotExistException {
        // TODO implement API: POST /questions/{category}/{questionId}/answers => create a answer under question with {questionId}
        ...
        Answer result = repository.createAnswer(answer);
