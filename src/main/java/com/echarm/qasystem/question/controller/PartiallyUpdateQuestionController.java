...
/*
 * API for partially updating the Article with {articleId} in {category} collection of the database
 *
 * HTTP Request: PATCH /articles/{category}/{articleId}
 * HTTP Response:
 ...
 */
@RestController
public class PartiallyUpdateQuestionController {
	...
	@RequestMapping(value = "/articles/{category}/{articleId}", method=RequestMethod.PATCH)
	public Question partiallyUpdateArticle(@PathVariable String category, @PathVariable String articleId, @RequestBody(required=false) Question article)
